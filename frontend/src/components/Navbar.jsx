    ...
    <nav className="bg-white shadow-md p-4 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-6 items-center">
          ...
          {user && (
            <Link to="/dashboard" className="text-gray-600 hover:text-primary transition font-medium">
              Dashboard
            </Link>
          )}
          ...
          {user ? (
            <div className="flex items-center gap-4 ml-4 pl-4 border-l border-gray-200">
              <div className="flex items-center gap-2 text-dark font-medium">
                ...
                <span className="hidden md:block">{user.name.split(' ')[0]}</span> {/* Show First Name */}
              </div>
